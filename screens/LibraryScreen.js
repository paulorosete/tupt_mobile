        ...
        return (
          <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionSubtitle}>New Library</Text>
            </View>
            
            <View style={styles.infoCard}>
              <Text style={styles.infoDescription}>
                A quiet space filled with books and resources for reading, learning, and research. Ideal for students, educators, and knowledge seekers.
              </Text>
            </View>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <LinearGradient colors={['#1a1a2e', '#16213e']} style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.title}>New Library</Text>
          <Text style={styles.subtitle}>Books and resources for learning</Text>
        </View>
      </LinearGradient>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>🗺️ Library Directions</Text>
