        ...
        return (
          <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionSubtitle}>Welcome to the Admin Building</Text>
            </View>
            
            <View style={styles.infoCard}>
              <Text style={styles.infoDescription}>
                A central hub for managing school operations, supporting staff, and ensuring smooth day-to-day activities. Ideal for administrators and faculty.
              </Text>
            </View>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <LinearGradient colors={['#1a1a2e', '#16213e']} style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.subtitle}>Admin Building</Text>
        </View>
      </LinearGradient>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>🗺️ Admin Building Directions</Text>
              <TouchableOpacity style={styles.modalCloseButton} onPress={toggleImageModal}>
                <Text style={styles.modalCloseText}>✕</Text>
              </TouchableOpacity>
            </View>
            <Image 
              source={require('../assets/gymDir.jpg')} 
...
export default AdminBuildingcreen;