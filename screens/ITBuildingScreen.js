        ...
        return (
          <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionSubtitle}>Welcome to the IT Building - Your gateway to technology education</Text>
            </View>
            
            <View style={styles.infoCard}>
              <Text style={styles.infoDescription}>
                The IT Building is a state-of-the-art facility designed to provide students with cutting-edge technology and learning environments. Our building houses modern computer laboratories, faculty offices, and event spaces.
              </Text>
            </View>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <LinearGradient colors={['#1a1a2e', '#16213e']} style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.title}>IT Building</Text>
          <Text style={styles.subtitle}>Information Technology Center</Text>
        </View>
      </LinearGradient>
...
export default ITBuildingScreen;