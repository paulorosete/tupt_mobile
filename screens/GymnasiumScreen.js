        ...
        return (
          <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionSubtitle}>Gymnasium</Text>
            </View>
            
            <View style={styles.infoCard}>
              <Text style={styles.infoDescription}>
                A dynamic space designed for physical activity, sports, and fitness. Ideal for students, athletes, and health enthusiasts.
              </Text>
            </View>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <LinearGradient colors={['#1a1a2e', '#16213e']} style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.title}>Gymnasium</Text>
          <Text style={styles.subtitle}>We encourage students to stay active and healthy by participating in gymnasium activities.</Text>
        </View>
      </LinearGradient>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>🗺️ Gymnasium Directions</Text>
              <TouchableOpacity style={styles.modalCloseButton} onPress={toggleImageModal}>
                <Text style={styles.modalCloseText}>✕</Text>
              </TouchableOpacity>
            </View>
            <Image 
              source={require('../assets/gymdir2.jpg')} 
...
export default GymnasiumScreen;