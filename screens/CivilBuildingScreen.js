...
const CivilBuildingScreen = () => {
      ...
      case 'faculty2':
        return (
          <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
            ...
            {facultyGroup2.map(person => (
              <FacultyCard key={`group2-${person.id}`} person={person} />
            ))}
          </ScrollView>
        );
      case 'faculty3':
        return (
          <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
            ...
            {facultyGroup3.map(person => (
              <FacultyCard key={`group3-${person.id}`} person={person} />
            ))}
          </ScrollView>
        );
      default:
        return (
          <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={styles.sectionSubtitle}>Welcome to the Civil and Allied Department</Text>
            </View>
            
            <View style={styles.infoCard}>
              <Text style={styles.infoDescription}>
               The Civil and Allied Engineering is a modern facility equipped with advanced laboratories, design studios, and classrooms, providing students with hands-on experience and practical knowledge in engineering and construction fields.
              </Text>
            </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Enhanced Tab Container with 5 tabs */}
      <ScrollView 
        horizontal 
      ...
      >
        {[
          ...
          { key: 'faculty1', label: 'BSCE Faculty', icon: '👥' },
          { key: 'faculty2', label: 'BSCT & BSES Faculty', icon: '👨‍🏫' },
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>🗺️ Civil Building Direction</Text>
              <TouchableOpacity style={styles.modalCloseButton} onPress={toggleImageModal}>
                <Text style={styles.modalCloseText}>✕</Text>
              </TouchableOpacity>
            </View>
            <Image 
              source={require('../assets/civilDirection.jpg')} 
...
export default CivilBuildingScreen;